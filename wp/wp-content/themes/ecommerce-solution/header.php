      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-12">
            <div class="logo">
              <div class="row">
                <div class="<?php if( get_theme_mod( 'ecommerce_solution_site_logo_inline') != '') { ?>col-lg-5 col-md-5"<?php } else { ?>col-lg-12 col-md-12  <?php } ?>">
                  <?php if ( has_custom_logo() ) : ?>
                    <div class="site-logo"><?php the_custom_logo(); ?></div>
                  <?php endif; ?>
                </div>
                <div class="<?php if( get_theme_mod( 'ecommerce_solution_site_logo_inline') != '') { ?>col-lg-7 col-md-7 site-logo-inline"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
